...
import dock from "../assets/coffee/coffeePouder(8).jpg";
import pershoes from "../assets/coffee/coffeeDrink1 (12).jpg";
import reflectedshoe from  "../assets/coffee/coffeePouder(1).jpg";
import sticks from  "../assets/coffee/coffeeDrink1 (14).jpg";
