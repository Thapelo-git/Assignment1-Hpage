...
function Landing() {
  return (
    <div className=" snap-y   w-full  h-full">
      ...
      <FirstSection className="mt-0 -mt-[80px] h-[calc(100vh+80px)]" text1="FOR COLOURFUL " text2="STEPS IN LIFE"  bgImg={coverpic} button={<button className="bg-teal-400 h-15 hover:bg-teal-300  text-center text-l  text-white rounded-4xl w-60">VISIT OUR SHOP</button>} />
